...
public class DataBootLoader {
	...
	public CommandLineRunner bookingDataLoader(BookingRepository bookingRepository) {
		return args -> {
			...
			Booking booking1 = new Booking(LocalDate.of(2024, 10, 1), LocalDate.of(2024, 12, 1), "Mumbai", "Lonavala",
					"Borivali", "Lonavala", 5);
			Booking booking2 = new Booking(LocalDate.of(2024, 9, 1), LocalDate.of(2024, 10, 11), "Delhi", "Kashmir",
					"Delhi Gate", "Kashmir center", 2);
			Booking booking3 = new Booking(LocalDate.of(2024, 11, 4), LocalDate.of(2024, 12, 11), "Mumbai", "Badrinath",
					"Borivali", "Temple", 7);
			Booking booking4 = new Booking(LocalDate.of(2024, 1, 10), LocalDate.of(2024, 2, 1), "Kolkata", "Mumbai",
					"Kolkata", "Mumbai", 4);
